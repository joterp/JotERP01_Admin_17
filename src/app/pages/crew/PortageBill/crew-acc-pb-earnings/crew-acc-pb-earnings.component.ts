...
@Component({
  selector: 'fury-crew-acc-pb-earnings',
  templateUrl: './crew-acc-pb-earnings.component.html',
  styleUrls: ['./crew-acc-pb-earnings.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class CREWACCPBEarningsComponent implements OnInit {
  ...
  EarningsFilterForm:UntypedFormGroup;
  ...
  ngOnInit(): void {
    ...
    this.EarningsFilterForm = this.fb.group({
      drpManning_Office:[''],
      drpRank:[''],
      txtStaff_Code:[''],
      chkAmount:['']
