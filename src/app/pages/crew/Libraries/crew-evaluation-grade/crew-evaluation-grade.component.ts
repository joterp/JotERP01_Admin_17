...
import { CREWInterviewGradeAddComponent } from '../crew-interview-grade/crewinterview-grade-add/crewinterview-grade-add.component';
...
@Component({
  selector: 'fury-crew-evaluation-grade',
  templateUrl: './crew-evaluation-grade.component.html',
  styleUrls: ['./crew-evaluation-grade.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CREWEvaluationGradeComponent implements OnInit {
  pageSize = 10;
