...
import { CREWEvaluationPeriodAddComponent } from './crew-evaluation-period-add/crew-evaluation-period-add.component';
...
@Component({
  selector: 'fury-crew-evaluation-period',
  templateUrl: './crew-evaluation-period.component.html',
  styleUrls: ['./crew-evaluation-period.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CREWEvaluationPeriodComponent implements OnInit {
  pageSize = 10;
  ...
  saveEvaluationQueCategory(data:object, IsEdit:boolean) {
    const dialogRef = this.dialog.open(CREWEvaluationPeriodAddComponent,
      {
        width: "25%",
        maxHeight: "90%",
        disableClose: true,
