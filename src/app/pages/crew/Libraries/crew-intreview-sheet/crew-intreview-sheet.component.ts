...
import { CREWIntreviewSheetAddComponent } from './crew-intreview-sheet-add/crew-intreview-sheet-add.component';
import { MatTableDataSource } from '@angular/material/table';
import { MatSort } from '@angular/material/sort';
import { MatDialog } from '@angular/material/dialog';

@Component({
  selector: 'fury-crew-intreview-sheet',
  templateUrl: './crew-intreview-sheet.component.html',
  styleUrls: ['./crew-intreview-sheet.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CREWIntreviewSheetComponent implements OnInit {
  pageSize = 10;
  ...
  saveInterviewSheet(data:object, IsEdit:boolean) {
    const dialogRef = this.dialog.open(CREWIntreviewSheetAddComponent,
      {
        width: "25%",
        maxHeight: "90%",
        disableClose: true,
