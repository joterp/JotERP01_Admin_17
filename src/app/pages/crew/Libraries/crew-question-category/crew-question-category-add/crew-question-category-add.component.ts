...
@Component({
  selector: 'fury-crew-question-category-add',
  templateUrl: './crew-question-category-add.component.html',
  styleUrl: './crew-question-category-add.component.scss'
})
export class CrewQuestionCategoryAddComponent {
  [x: string]: any;
  ...
  constructor(private dialogRef: MatDialogRef<CrewQuestionCategoryAddComponent>,
