...
import { AccountsLibDrcCategoryAddComponent } from './accounts-lib-drc-category-add/accounts-lib-drc-category-add.component';

@Component({
  selector: 'fury-accounts-lib-drc-category',
  templateUrl: './accounts-lib-drc-category.component.html',
  styleUrl: './accounts-lib-drc-category.component.scss'
})
export class AccountsLibDrcCategoryComponent {
  pageSize = 10;
  ...
  constructor(
    ...
    this.titleService.setTitle('AccountCodeCategory');
  ...
  columns: ListColumn[] = [
    ...
    { property: 'Category_Code', visible: true, name: 'Category_Code' },
  ...
  clearFilter() {
    ...
    this.categoryFormGroup.get('drpStatus').patchValue('1');
    // this.fetchrankCategory();
  }
  ...
  saveCategory(data: object, IsEdit: boolean) {
    const dialogRef = this.dialog.open(AccountsLibDrcCategoryAddComponent, {
      width: '35%',
      maxHeight: '90%',
      disableClose: true,
    });
