...
@Component({
  selector: 'fury-hrm-interview-grade-add',
  templateUrl: './hrm-interview-grade-add.component.html',
  styleUrl: './hrm-interview-grade-add.component.scss'
})
export class HrmInterviewGradeAddComponent {
  ...
  modeltitle : string = "";
  EditData:any;
  constructor(private dialogRef: MatDialogRef<HrmInterviewGradeAddComponent>,
