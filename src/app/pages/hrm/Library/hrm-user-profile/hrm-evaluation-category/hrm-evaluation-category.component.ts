...
import { HrmEvaluationCategoryAddComponent } from './hrm-evaluation-category-add/hrm-evaluation-category-add.component';
// import { HrmEvaluationCategoryAddComponent } from './hrm-evaluation-category-add/hrm-evaluation-category-add.component';

@Component({
  selector: 'fury-hrm-evaluation-category',
  templateUrl: './hrm-evaluation-category.component.html',
  styleUrl: './hrm-evaluation-category.component.scss'
})
export class HrmEvaluationCategoryComponent {
  pageSize = 10;
  ...
  saveEvaluationQueCategory(data:object, IsEdit:boolean) {
    const dialogRef = this.dialog.open(HrmEvaluationCategoryAddComponent,
      {
        width: "25%",
        maxHeight: "90%",
        disableClose: true,
