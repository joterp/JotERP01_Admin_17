...
import { HrmInterviewCategoryAddComponent } from './hrm-interview-category-add/hrm-interview-category-add.component';

@Component({
  selector: 'fury-hrm-interview-category',
  templateUrl: './hrm-interview-category.component.html',
  styleUrl: './hrm-interview-category.component.scss'
})
export class HrmInterviewCategoryComponent {
  pageSize = 10;

  dataSource: MatTableDataSource<HrmInterviewCategoryComponent>;
  ...
  saveIntQueCategory(data:object, IsEdit:boolean) {
    const dialogRef = this.dialog.open(HrmInterviewCategoryAddComponent,
      {
        width: "35%",
        maxHeight: "90%",
        disableClose: true,
