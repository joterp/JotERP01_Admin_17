...
@Component({
  selector: 'fury-hrm-interview-category-add',
  templateUrl: './hrm-interview-category-add.component.html',
  styleUrl: './hrm-interview-category-add.component.scss'
})
export class HrmInterviewCategoryAddComponent {
  [x: string]: any;
  ...
  constructor(private dialogRef: MatDialogRef<HrmInterviewCategoryAddComponent>,
