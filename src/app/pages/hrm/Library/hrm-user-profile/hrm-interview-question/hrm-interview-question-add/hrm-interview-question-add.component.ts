...
@Component({
  selector: 'fury-hrm-interview-question-add',
  templateUrl: './hrm-interview-question-add.component.html',
  styleUrls: ['./hrm-interview-question-add.component.scss']
})
export class HrmInterviewQuestionAddComponent {
  IsEdit: boolean;
  ...
  EditData: object;
  constructor(private dialogRef: MatDialogRef<HrmInterviewQuestionAddComponent>,
