...
@Component({
  selector: 'fury-hrm-evaluation-question-add',
  templateUrl: './hrm-evaluation-question-add.component.html',
  styleUrl: './hrm-evaluation-question-add.component.scss'
})
export class HrmEvaluationQuestionAddComponent {
  [x: string]: any;
  ...
  constructor(private dialogRef: MatDialogRef<HrmEvaluationQuestionAddComponent>,
