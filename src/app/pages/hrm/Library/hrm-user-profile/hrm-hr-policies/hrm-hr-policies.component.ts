...
import { Component, ElementRef, Injectable, Input, ViewChild, ViewEncapsulation } from '@angular/core';
...
"1 - SHIP GENERAL" :{
'SPECIFICATION, ESTIMATING, DRAWING, INSTRUCTION, COURSES':{
  'CONTRACT/SPECIFIC, WORK, GENERAL DESIGN, MODEL TESTING':{
    '101.001 - Towing tank tests':null,
    '101.005 - Funnel tests':null
  }
},
'INSURANCE, FEES, CERTIFICATES, REPRESENTATION':{
  'GENERAL INSURANCE':{
  '111.001 - Construction risk insurance':null,
  '111.005 - Trial trip insurance':null,
  '111.010 - Delay insurance':null
  }
},
...
'HULL MATERIALS, GENERAL HULL WORK':{
  'HULL MATERIALS':{
    '201.001 - Steel ship plates':null,
    '201.005 - High tension steel ship plates':null
  }
},
'TRANSPORTATION, SORTING, & STORAGE OF HULL MATERIALS':{

  '202.001 - Crane hire':null,
  '202.005 - Forklift hire':null,
  '202.010 - Truck hire':null     
},   
},
};
@Injectable()
...
@Component({
  selector: 'fury-hrm-hr-policies',
  templateUrl: './hrm-hr-policies.component.html',
  styleUrls: ['./hrm-hr-policies.component.scss'],
...
export class HrmHrPoliciesComponent {
...
administrationFormGroup:UntypedFormGroup;
...
{ property: "Procedure_Code", visible: true, name: "Procedure_Code" },
{ property: "Procedure_Name", visible: true, name: "Procedure_Name" },
{ property: "Version", visible: true, name: "Version" },
{ property: "Uploaded_By", visible: true, name: "Uploaded_By" },
{ property: "Uploaded_On", visible: true, name: "Uploaded_On" },

] as ListColumn[];

notassigncolumn: ListColumn[] = [
{ property: "User_Name", visible: true, name: "User_Name" },
...
constructor( private titleService: Title, private api: ApiService, private auth: AuthGuard,private sidenavService: SidenavService,
  private common: CommonService, private dialog: MatDialog, private fb: UntypedFormBuilder,private _database: ChecklistDatabase) {
    this.titleService.setTitle(`HR Policies`);
...
ngOnInit(): void {
  ...
  this.administrationFormGroup = this.fb.group({
    Department_Name: [""],
