...
@Component({
  selector: 'fury-admin-child-add',
  templateUrl: './admin-child-add.component.html',
  styleUrl: './admin-child-add.component.scss'
})
export class AdminChildAddComponent {
  IsEdit: boolean;
  newAlarmFormGroup: UntypedFormGroup;
  ErrorMessage: string = "";
  submit: boolean = false;
  modeltitle: string;
  constructor(private dialogRef: MatDialogRef<AdminChildAddComponent>,
