...
@Component({
  selector: 'fury-admin-vessel-flags-add',
  templateUrl: './admin-vessel-flags-add.component.html',
  styleUrl: './admin-vessel-flags-add.component.scss'
})
export class AdminVesselFlagsAddComponent {
  [x: string]: any;
  IsEdit: boolean = false;
  EditData:any;
  // IsEdit: boolean;
  newvesselFlagFormGroup: UntypedFormGroup;
  ErrorMessage: string = "";
  submit: boolean = false;
  constructor(private dialogRef: MatDialogRef<AdminVesselFlagsAddComponent>,
  ...
  ngOnInit(): void {
    ...
    this.newvesselFlagFormGroup = this._fb.group({
      Vessel_Flag: ["", Validators.required],
...
//     this.submit = true;
//     var data: object = {};
//     for (const elem in this.newvesselFlagFormGroup.value) {
//       data[elem] = this.newvesselFlagFormGroup.value[elem];
//     }
...
//         if (Number.isInteger(res)) {
//           if (addMore) {
//             this.newvesselFlagFormGroup.reset();
//             this.IsEdit = false;
...
//   }
//   InsertFormValues() {
//     var fc: object = this.newvesselFlagFormGroup.controls;
