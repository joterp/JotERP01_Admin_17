...
import { AdminVesselFlagsAddComponent } from './admin-vessel-flags-add/admin-vessel-flags-add.component';

@Component({
  selector: 'fury-admin-vessel-flags',
  templateUrl: './admin-vessel-flags.component.html',
  styleUrl: './admin-vessel-flags.component.scss'
})
export class AdminVesselFlagsComponent {
  pageSize = 10;
  ...
  columns: ListColumn[] = [
    ...
    { property: 'Flag_Name', visible: true, name: 'Flag_Name' },
  ...
  saveVessel(data: object, IsEdit: boolean) {
    const dialogRef = this.dialog.open(AdminVesselFlagsAddComponent, {
      width: '35%',
      maxHeight: '90%',
      disableClose: true,
    });
