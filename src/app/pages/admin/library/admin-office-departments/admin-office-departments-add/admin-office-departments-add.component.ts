...
@Component({
  selector: 'fury-admin-office-departments-add',
  templateUrl: './admin-office-departments-add.component.html',
  styleUrl: './admin-office-departments-add.component.scss'
})
export class AdminOfficeDepartmentsAddComponent {
  [x: string]: any;
  IsEdit: boolean = false;
  EditData:any;
  // IsEdit: boolean;
  newOfficeDepartmentFormGroup: UntypedFormGroup;
  ErrorMessage: string = "";
  submit: boolean = false;
  constructor(private dialogRef: MatDialogRef<AdminOfficeDepartmentsAddComponent>,
  ...
  ngOnInit(): void {
    ...
    this.newOfficeDepartmentFormGroup = this._fb.group({
...
//     this.submit = true;
//     var data: object = {};
//     for (const elem in this.newOfficeDepartmentFormGroup.value) {
//       data[elem] = this.newOfficeDepartmentFormGroup.value[elem];
//     }
...
//         if (Number.isInteger(res)) {
//           if (addMore) {
//             this.newOfficeDepartmentFormGroup.reset();
//             this.IsEdit = false;
...
//   }
//   InsertFormValues() {
//     var fc: object = this.newOfficeDepartmentFormGroup.controls;
