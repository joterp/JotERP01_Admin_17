...
import { AdminCountriesAddComponent } from './admin-countries-add/admin-countries-add.component';
@Component({
  selector: 'fury-admin-countries',
...
export class AdminCountriesComponent {
  ...
  loading: boolean;
  countriesFormGroup: UntypedFormGroup;
  ...
  @Input()
  columns: ListColumn[] = [
    { property: 'Country_Name', visible: true, name: 'Country_Name' },
    { property: 'ISO_Code_2', visible: true, name: 'ISO_Code_2' },
    { property: 'ISO_Code_3', visible: true, name: 'ISO_Code_3' },
    { property: 'Capital', visible: true, name: 'Capital' },
    { property: 'Continent', visible: true, name: 'Continent' },
    { property: 'Time_Zone', visible: true, name: 'Time_Zone' },
  ...
  ngOnInit(): void {
    ...
    this.countriesFormGroup = this.fb.group({
      txtCountry_Name: [""],
      txt_Capital: [""],
      Code_Three_Char: [""],
      Code_Two_Char: [""],
  ...
  clearFilter() {
    ...
    this.countriesFormGroup.get('drpStatus').patchValue('1');
    // this.fetchrankCategory();
  }
  ...
  saveCity(data: object, IsEdit: boolean) {
    const dialogRef = this.dialog.open(AdminCountriesAddComponent, {
      width: '35%',
      maxHeight: '90%',
      disableClose: true,
    });
