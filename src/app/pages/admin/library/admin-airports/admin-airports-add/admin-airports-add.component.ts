...
@Component({
  selector: 'fury-admin-airports-add',
  templateUrl: './admin-airports-add.component.html',
  styleUrls: ['./admin-airports-add.component.scss']
})
export class AdminAirportsAddComponent {
// IsEdit: boolean;
  // [x: string]: any;
  // newairpotFormGroup: UntypedFormGroup;
  // ErrorMessage: string = "";
  ...
  ErrorMessage: string = "";
  submit: boolean = false;
  constructor(private dialogRef: MatDialogRef<AdminAirportsAddComponent>,
  ...
  ngOnInit(): void {
    ...
    this.newairpotFormGroup = this._fb.group({
...
//     this.submit = true;
//     var data: object = {};
//     for (const elem in this.newairpotFormGroup.value) {
//       data[elem] = this.newairpotFormGroup.value[elem];
//     }
...
//   }
//   InsertFormValues() {
//     var fc: object = this.newairpotFormGroup.controls;
