...
@Component({
  selector: 'fury-admin-fleets-add',
  templateUrl: './admin-fleets-add.component.html',
  styleUrl: './admin-fleets-add.component.scss'
})
export class AdminFleetsAddComponent {
  [x: string]: any;
  ...
  constructor(private dialogRef: MatDialogRef<AdminFleetsAddComponent>,
  ...
  ngOnInit(): void {
    ...
    this.newvesselFormGroup = this._fb.group({
      ...
      Fleet_Name: ["", Validators.required],
      Superintendent:[""],
