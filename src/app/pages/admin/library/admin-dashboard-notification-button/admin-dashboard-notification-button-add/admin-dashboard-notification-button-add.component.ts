...
@Component({
  selector: 'fury-admin-dashboard-notification-button-add',
  templateUrl: './admin-dashboard-notification-button-add.component.html',
  styleUrl: './admin-dashboard-notification-button-add.component.scss'
})
export class AdminDashboardNotificationButtonAddComponent {
  [x: string]: any;
  IsEdit: boolean = false;
  EditData:any;
  // IsEdit: boolean;
  newnotificationFormGroup: UntypedFormGroup;
  ErrorMessage: string = "";
  submit: boolean = false;
  constructor(private dialogRef: MatDialogRef<AdminDashboardNotificationButtonAddComponent>,
  ...
  ngOnInit(): void {
    ...
    this.newnotificationFormGroup = this._fb.group({
      Module: [""],
...
//     this.submit = true;
//     var data: object = {};
//     for (const elem in this.newnotificationFormGroup.value) {
//       data[elem] = this.newnotificationFormGroup.value[elem];
//     }
...
//         if (Number.isInteger(res)) {
//           if (addMore) {
//             this.newnotificationFormGroup.reset();
//             this.IsEdit = false;
...
//   }
//   InsertFormValues() {
//     var fc: object = this.newnotificationFormGroup.controls;
