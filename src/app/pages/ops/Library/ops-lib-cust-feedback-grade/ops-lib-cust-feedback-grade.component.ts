...
import { OpsLibCustFeedbackGradeAddComponent } from './ops-lib-cust-feedback-grade-add/ops-lib-cust-feedback-grade-add.component';

@Component({
  selector: 'fury-ops-lib-cust-feedback-grade',
  templateUrl: './ops-lib-cust-feedback-grade.component.html',
  styleUrl: './ops-lib-cust-feedback-grade.component.scss'
})
export class OpsLibCustFeedbackGradeComponent {
  pageSize = 10;
