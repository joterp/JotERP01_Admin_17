...
import { OpsLibPortcallFeedbackCategoryAddComponent } from '../ops-lib-portcall-feedback-category/ops-lib-portcall-feedback-category-add/ops-lib-portcall-feedback-category-add.component';
@Component({
  selector: 'fury-ops-lib-portcall-feedback-question',
  templateUrl: './ops-lib-portcall-feedback-question.component.html',
  styleUrl: './ops-lib-portcall-feedback-question.component.scss'
})
export class OpsLibPortcallFeedbackQuestionComponent {
  pageSize = 10;
  ...
  saveFeedbackQuestion(data:object, IsEdit:boolean) {
    const dialogRef = this.dialog.open(OpsLibPortcallFeedbackCategoryAddComponent,
      {
        width: "25%",
        maxHeight: "90%",
        disableClose: true,
