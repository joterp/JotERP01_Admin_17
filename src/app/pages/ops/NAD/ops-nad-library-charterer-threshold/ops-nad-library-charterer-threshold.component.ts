...
@Component({
  selector: 'fury-ops-nad-library-charterer-threshold',
  templateUrl: './ops-nad-library-charterer-threshold.component.html',
  styleUrls: ['./ops-nad-library-charterer-threshold.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class OPSNADLIBRARYCHARTERERTHRESHOLDComponent implements OnInit {
  ...
  constructor(private titleService:Title, private sidenavService:SidenavService, private router:Router) {
    this.titleService.setTitle(`Charter-Party Consumtions' Threshold`);
   }
